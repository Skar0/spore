import bddcython.gpg2bdd
import bddcython.generalizedRecursive
import dd.cudd as _bdd
import bddcython.misc

manager = _bdd.BDD()
arena, all_vertices = bddcython.gpg2bdd.gpg2bdd("./arenas/gpg/example_4.gpg", manager)
winning_region_player0, winning_region_player1 = bddcython.generalizedRecursive.generalized_recursive(arena, manager)
